  ...
  return (
    <div className="grid h-screen w-full">
      <div className="flex flex-col">
        ...
        <main className="grid flex-1 gap-4 overflow-auto lg:p-4   lg:grid-cols-3">
          <div className="relative hidden flex-col items-start gap-8 lg:flex">
            <div className="grid w-full items-start gap-6">
              <fieldset className="grid gap-6 lg:rounded-lg border p-4">
                      ...
                      <SelectItem value="explorer">
                        <div className="flex items-start gap-3 text-muted-foreground">
                          ...
                          <div className="grid gap-0.5">
                            ...
                            <p className="text-xs" data-description>
                              Perdivance and speed for efficiency.
                            </p>
                          </div>
                        </div>
                      </SelectItem>
